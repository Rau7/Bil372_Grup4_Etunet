...
<form action="<?php echo MAIN; ?>Student_resource/handle_update/<?php echo $resource['resource_id']; ?>" method="POST">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="homework_short" aria-describedby="emailHelp" placeholder="Resource Short Description" name="resource_short_desc" value="<?php echo $resource['resource_short_desc']; ?>">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="resource" aria-describedby="emailHelp" placeholder="Resources Resource" name="resource_url" value="<?php echo $resource['resource_url']; ?>">
  </div>

...
<form action="<?php echo MAIN; ?>Posts/handle_comment_update/<?php echo $comment['comment_id']; ?>/<?php echo $comment['comment_post_id']; ?>" method="POST">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="comment_des" aria-describedby="emailHelp" placeholder="Comment Description" name="comment_des" value="<?php echo $comment['comment_desc']; ?>">
  </div>
